...
const AuthorPage: FC<AuthorPageProps> = ({ params, searchParams }) => {
  let [categories] = useState(["Carros"]);

    console.log('JORDAN VALDEZ, params', params);
    console.log('JORDAN VALDEZ, searchParams', searchParams);
